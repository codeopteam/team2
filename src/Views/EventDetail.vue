        ...
        <div>
          ...
          <div class="w-60 flex">
            <div>
              ...
              <BuyTicketButton label="Add to Cart" icon="/bag.png" customClasses="bg-darkBlue text-white gap-2" class="mb-7 ms-4" @click.stop="cartStore.addItemToCart(eventDetailresp)"></BuyTicketButton>
